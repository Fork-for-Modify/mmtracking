...
class BaseSCIDetector(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self, init_cfg):
        super(BaseSCIDetector, self).__init__(init_cfg)
    ...
    @abstractmethod
    def simple_test(self, frames, sci_mask, coded_meas, **kwargs):
        pass

    def aug_test(self, frames, sci_mask, coded_meas, **kwargs):
        """Test function with test time augmentation."""
        pass

    def forward_test(self, frames, sci_mask, coded_meas, **kwargs):
        """
        Args:
        sci_mask: sci encoding masks
        coded_meas: coded measurements
        ...
        if num_augs == 1:
            ...
            return self.simple_test(frames, sci_mask, coded_meas, **kwargs)
        else:
    ...
    def forward(self, frames, sci_mask, coded_meas, return_loss=True, **kwargs):
        ...
        """
        if return_loss:
            return self.forward_train(frames, sci_mask, coded_meas, **kwargs)
        else:
            return self.forward_test(frames, sci_mask, coded_meas, **kwargs)
